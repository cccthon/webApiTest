...
class PicoFollowFxcm(unittest.TestCase):
    def setUp(self):
        '''跟随者登录'''
        #跟随者登录
    ...
    def test_PicoFollowFxcm(self):
        '''KVB账户跟随福汇交易员，建立跟随（固定跟随）->跟随下单->跟随平仓->查看跟随交易历史订单->取消跟随'''
...
if __name__ == '__main__':
    suite = unittest.TestSuite(unittest.makeSuite(PicoFollowFxcm))
