...
from social3 import social3Message_pb2
from social3 import social3Message_pb2_grpc
from social3 import social3Service_pb2
from social3 import social3Service_pb2_grpc
...
class RegisterByEmail(unittest.TestCase):
    def setUp(self):
        ##alibeta 环境连接信息 ++++++++++++++++++++++++++++++++
        #连接NewSocial测试服务器
        consulSocialHost = FMCommon.consul_operater(host=userData['consulHost'],port=userData['consulPort'],server='followme.srv.NewSocial',key='ServiceAddress')
        consulSocialPort = FMCommon.consul_operater(host=userData['consulHost'],port=userData['consulPort'],server='followme.srv.NewSocial',key='ServicePort')
        socialChannel = grpc.insecure_channel(consulSocialHost + ':' + str(consulSocialPort))
        self.socailStub = social3Service_pb2_grpc.SocialServiceStub(socialChannel)
        print(self.socailStub)
