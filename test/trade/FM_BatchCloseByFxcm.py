...
class BatchCloseByFxcm(unittest.TestCase):
    def setUp(self):
        # 登录
    ...
    def test_BatchCloseByFXCM(self):
        ...
        if (closeOrderRes["code"] == userDataWebSocket['ws_code_0']):
            self.assertEqual(closeOrderRes["rcmd"], userDataWebSocket['ws_code_210'])
        elif (closeOrderRes["code"] == 4):
            print("保证金不足！")
        elif (closeOrderRes["code"] == 10):
            print("市场关闭！")
        elif (closeOrderRes["code"] == 300):
            print("服务器内部错误！")
        elif (closeOrderRes["code"] == 3):
            print("客户不存在！")
        elif (closeOrderRes["code"] == 7):
            print("获取价格失败！")
        elif (closeOrderRes["code"] == 9):
            print("手数错误！")
        elif (closeOrderRes["code"] == 18):
            print("此品种不能交易！")
        else:
            print("其它错误")
...
if __name__ == '__main__':
    suite = unittest.TestSuite(unittest.makeSuite(BatchCloseByFxcm))
