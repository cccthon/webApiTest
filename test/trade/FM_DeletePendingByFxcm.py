...
class DeletePendingByFxcm(unittest.TestCase):
    def setUp(self):
        # 登录
    ...
    def test_DeletePendingByFxcm(self):
        '''登录->切换到福汇账户->获取交易token->新建一个挂单->删除挂单->退出登录'''
        ...
        self.assertEqual(createPendingRes["order"]["symbol"], "AUD/CAD")
...
if __name__ == '__main__':
    suite = unittest.TestSuite(unittest.makeSuite(DeletePendingByFxcm))
