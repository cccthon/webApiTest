...
class CheckFullStopByKVB(unittest.TestCase):
    def setUp(self):
        # 登录
    ...
    def test_CheckFullStopByKVB(self):
        '''登录->切换到kvb账户->获取交易token->开仓>订单止损止盈->查看持仓订单->退出登录'''
...
if __name__ == '__main__':
    suite = unittest.TestSuite(unittest.makeSuite(CheckFullStopByKVB))
