#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: FM_statistic_oenTIme_totalWeek
# 用例标题: opentime week表统计
# 预置条件: 
# 测试步骤:
# 预期结果:
# 脚本作者: shencanhui
...
class UserInfo(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        table = 'mg_result_week'
        #查询星期几的数据
        self.week = 2
        mongoFind = {"login": self.login,"brokerid": self.brokerID,"close_week": self.week}
    ...
    def test_1_pointop_close_profit(self):
        '''openTIme: 平仓盈利总点数'''
        pointop_close_profit = Statistic_V2.getPrestoData(login=self.login,brokerID=self.brokerID,week=self.week,quotaValue='pointop_close_profit',updatets=self.updatets)
    ...
    def test_2_pointop_close_loss(self):
        '''openTIme: 平仓亏损总点数'''
        pointop_close_loss = Statistic_V2.getPrestoData(login=self.login,brokerID=self.brokerID,week=self.week,quotaValue='pointop_close_loss',updatets=self.updatets)
    ...
    def test_3_moneyop_close_profit(self):
        '''openTIme: 平仓盈利总收益'''
        moneyop_close_profit = Statistic_V2.getPrestoData(login=self.login,brokerID=self.brokerID,week=self.week,quotaValue='moneyop_close_profit',updatets=self.updatets)
    ...
    def test_4_moneyop_close_loss(self):
        '''openTIme: 平仓亏损总收益'''
        moneyop_close_loss = Statistic_V2.getPrestoData(login=self.login,brokerID=self.brokerID,week=self.week,quotaValue='moneyop_close_loss',updatets=self.updatets)
    ...
    def test_5_standardlotsop_close(self):
        '''openTIme: 平仓总标准手'''
        standardlotsop_close = Statistic_V2.getPrestoData(login=self.login,brokerID=self.brokerID,week=self.week,quotaValue='standardlotsop_close',updatets=self.updatets)
    ...
    def test_6_standardlotsop_close_profit(self):
        '''openTIme: 平仓盈利总标准手'''
        standardlotsop_close_profit = Statistic_V2.getPrestoData(login=self.login,brokerID=self.brokerID,week=self.week,quotaValue='standardlotsop_close_profit',updatets=self.updatets)
    ...
    def test_7_standardlotsop_close_loss(self):
        '''openTIme: 平仓亏损总标准手'''
        standardlotsop_close_loss = Statistic_V2.getPrestoData(login=self.login,brokerID=self.brokerID,week=self.week,quotaValue='standardlotsop_close_loss',updatets=self.updatets)
    ...
    def test_8_standardlotsop_close_short(self):
        '''openTIme: 平仓做空总标准手'''
        standardlotsop_close_short = Statistic_V2.getPrestoData(login=self.login,brokerID=self.brokerID,week=self.week,quotaValue='standardlotsop_close_short',updatets=self.updatets)
    ...
    def test_9_standardlotsop_close_long(self):
        '''openTIme: 平仓做多总标准手'''
        standardlotsop_close_long = Statistic_V2.getPrestoData(login=self.login,brokerID=self.brokerID,week=self.week,quotaValue='standardlotsop_close_long',updatets=self.updatets)
