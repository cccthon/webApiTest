...
class UserInfo(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        table = 'mg_result_follall'
        mongoFind = {"login":login,"masteraccount":masteraccount,"masterbrokerid":masterbrokerid}
        ...
        self.prestoList = Statistic.prestoData(login = login, brokerID = brokerID,masteraccount=masteraccount)
