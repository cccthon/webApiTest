...
class FxcmFollowSam(unittest.TestCase):
    def setUp(self):
        '''跟随者登录'''
        #跟随者登录
    ...
    def test_FxcmFollowSam(self):
        ...
        print(self.followerSamAccountIndex)
...
if __name__ == '__main__':
    suite = unittest.TestSuite(unittest.makeSuite(FxcmFollowSam))
